...
const PricingStartup: React.FC = () => {
  const [annual, setAnnual] = useState(true);
  
  const plans: PricingPlan[] = [
    {
      name: 'Stage 1',
      price: annual ? '₹ 1,00,000' : '₹ 1,00,000',
      description: 'Perfect for small businesses and startups',
      features: [
        { text: 'Legal support ', included: true },
    ...
    },
    {
      ...
      features: [
        { text: 'Legal support ', included: true },
        { text: 'Technical support ', included: true },
        { text: 'Seed funding guidance ', included: true },
        { text: 'Human resource support ', included: true },
      ],
    },
    {
      name: 'Stage 3',
      price: annual ? '₹ 10,00,000' : '₹ 10,00,000',
      description: 'Ideal for growing businesses and teams',
      features: [
        { text: 'Legal support ', included: true },
        { text: 'Technical support ', included: true },
        { text: 'Seed funding arrangement ', included: true },
        { text: 'Equity Venture management ', included: true },
        { text: 'Data analysis ', included: true },
        { text: 'Business Connectivity Development (B2B) ', included: true },
        { text: 'Product Launch Support ', included: true },
        { text: 'Expertise Human Resource support ', included: true },
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-end mb-6">
                  ...
                  <span className="text-gray-400 ml-2 mb-1">{annual ? '' : '/month'}</span>
                </div>
